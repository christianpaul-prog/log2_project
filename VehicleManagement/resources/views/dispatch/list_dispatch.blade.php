                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->driver->gender }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Phone:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->driver->phone_number }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>License:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->driver->license_no }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Nationality:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->driver->nationality }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <strong>Full Name:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->name }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Phone:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->phone }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Company:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->company }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Pickup:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->pickup }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Drop-off:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->drop }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Estimated Cost:</strong>
                                                                    <p class="text-uppercase fw-bold text-success">
                                                                        ₱{{ number_format($trip->trip_cost, 2) }}</p>
                                                                </div>
                                                            </div>
                                                            <div class="mt-3">
                                                                <strong>Purpose:</strong>
                                                                <p class="text-uppercase text-muted">
                                                                    {{ $trip->reservation->purpose }}</p>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->vehicle->plate_no }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Model:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->vehicle->model }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Owner:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->vehicle->owner }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>License No:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->vehicle->license }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Type:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->vehicle->type }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <strong>Color:</strong>
                                                                    <p class="text-uppercase text-muted">
                                                                        {{ $trip->reservation->vehicle->color }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
