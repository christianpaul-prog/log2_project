...
@section('content')
    ...
    <h2 class="fw-bold">Driver Assign</h2>
    <p class="text-muted mt-2">
        View and manage all your reservations efficiently from one place.
        You can filter, edit, or delete reservation requests as needed.
    </p>
</div>
