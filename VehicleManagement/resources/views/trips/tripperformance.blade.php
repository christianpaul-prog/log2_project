                                ...
                                <div class="card-body">
                                    ...
                                    <div class="trip-item">
                                        <div class="row align-items-center">
                                            <div class="col-lg-2 col-md-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <br><small class="text-muted">Truck #001</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-4">
                                                <div>
                                                    <i class="fas fa-map-marker-alt text-success"></i> Manila
                                                    <i class="fas fa-arrow-right mx-2"></i>
                                                    <i class="fas fa-map-marker-alt text-danger"></i> Cebu
                                                </div>
                                                <small class="text-muted">450 km</small>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                                <small class="text-muted">Sep 8, 2024</small>
                                                <br><small>6.5 hrs</small>
                                            </div>
                                    ...
                                    <div class="trip-item">
                                        <div class="row align-items-center">
                                            <div class="col-lg-2 col-md-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <br><small class="text-muted">Van #007</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-4">
                                                <div>
                                                    <i class="fas fa-map-marker-alt text-success"></i> Quezon City
                                                    <i class="fas fa-arrow-right mx-2"></i>
                                                    <i class="fas fa-map-marker-alt text-danger"></i> Davao
                                                </div>
                                                <small class="text-muted">980 km</small>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                                <small class="text-muted">Sep 9, 2024</small>
                                                <br><small>8.2 hrs</small>
                                            </div>
                                            <div class="col-lg-1 col-md-1">
                                                <button class="btn btn-action btn-sm">
                                                    <i class="fas fa-eye"></i>
                                    ...
                                    <div class="trip-item">
                                        <div class="row align-items-center">
                                            <div class="col-lg-2 col-md-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <br><small class="text-muted">Truck #003</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-4">
                                                <div>
                                                    <i class="fas fa-map-marker-alt text-success"></i> Makati
                                                    <i class="fas fa-arrow-right mx-2"></i>
                                                    <i class="fas fa-map-marker-alt text-danger"></i> Baguio
                                                </div>
                                                <small class="text-muted">250 km</small>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                                <span class="status-badge status-completed">Completed</span>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                                <small class="text-muted">Sep 7, 2024</small>
                                                <br><small>4.5 hrs</small>
                                            </div>
                                            <div class="col-lg-1 col-md-1">
                                                <button class="btn btn-action btn-sm">
                                                    <i class="fas fa-eye"></i>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="driver-avatar" style="width: 30px; height: 30px; font-size: 0.8rem;">MG</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="driver-avatar" style="width: 30px; height: 30px; font-size: 0.8rem;">JS</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="driver-avatar" style="width: 30px; height: 30px; font-size: 0.8rem;">DL</div>
